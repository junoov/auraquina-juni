 ...
 * (Konfirmasi Bayar, Proses, Kemas, Kirim, Batalkan, Kembalikan dana,
 * Tinjau bantuan pelanggan, Ubah Alamat) biar gak ada duplikat & inkonsisten.
 */
class PesananActions
{
    ...
    /**
     * Tinjau bantuan pelanggan (retur / pengembalian dana / komplain).
     */
    public static function reviewAfterSales(): Action
    {
        return Action::make('reviewAfterSales')
            ->label('Tinjau bantuan pelanggan')
            ...
            ->action(function (Pesanan $record, array $data): void {
                ...
                Notification::make()->title('Status bantuan pelanggan diperbarui')->success()->send();
            });
    }
    ...
    public static function editAddress(): Action
    {
        return Action::make('editAddress')
            ...
            ], true) && (auth()->user()?->can('update_pesanan') ?? false))
            ->schema([
